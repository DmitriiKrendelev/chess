...
public class EvaluationFunctionMoves extends EvaluationFunctionMovesAbstract {
    public static final EvaluationFunction<BoardEngine> INSTANCE = new EvaluationFunctionMoves(true);
